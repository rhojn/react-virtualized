!(function(global, factory) {
  ...
  function _createSuper(Derived) {
    ...
    return function() {
      var call,
        self = _getPrototypeOf(Derived);
      return (
        (call = hasNativeReflectConstruct
          ? ((call = _getPrototypeOf(this).constructor),
            Reflect.construct(self, arguments, call))
          : self.apply(this, arguments)),
        (self = this),
        !(call = call) || ('object' != typeof call && 'function' != typeof call)
  ...
  function componentWillReceiveProps(nextProps) {
    ...
    this.setState(
      ...
      function(state) {
        return null !=
          (state = this.constructor.getDerivedStateFromProps(nextProps, state))
          ? state
          : null;
      }.bind(this),
    );
  ...
  function polyfill(Component) {
    ...
    if (
      ...
      prototype.componentDidUpdate = function(prevProps, prevState, snapshot) {
        ...
        snapshot = this.__reactInternalSnapshotFlag
    ...
    function ArrowKeyStepper() {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(_this), '_onKeyDown', function(
          ...
          var scrollToColumnPrevious = _this.props,
            columnCount = scrollToColumnPrevious.columnCount,
            scrollToRowPrevious = scrollToColumnPrevious.disabled,
            mode = scrollToColumnPrevious.mode,
            rowCount = scrollToColumnPrevious.rowCount;
        ...
        _defineProperty(
          ...
          '_onSectionRendered',
          function(rowStopIndex) {
            var columnStartIndex = rowStopIndex.columnStartIndex,
              columnStopIndex = rowStopIndex.columnStopIndex,
              rowStartIndex = rowStopIndex.rowStartIndex,
              rowStopIndex = rowStopIndex.rowStopIndex;
        ...
        [
          {
            ...
            value: function(scrollToRow) {
              var scrollToColumn = scrollToRow.scrollToColumn,
                scrollToRow = scrollToRow.scrollToRow;
              this.setState({
                scrollToRow: scrollToRow,
                scrollToColumn: scrollToColumn,
              });
          ...
          },
          {
            key: 'render',
            value: function() {
              var scrollToColumn = this.props,
                className = scrollToColumn.className,
                children = scrollToColumn.children,
                scrollToRow = this._getScrollState(),
                scrollToColumn = scrollToRow.scrollToColumn,
                scrollToRow = scrollToRow.scrollToRow;
          ...
          },
          {
            ...
            value: function(isControlled) {
              var scrollToColumn = isControlled.scrollToColumn,
                scrollToRow = isControlled.scrollToRow,
                onScrollToChange = this.props,
                isControlled = onScrollToChange.isControlled,
                onScrollToChange = onScrollToChange.onScrollToChange;
    ...
    if (!attachEvent) {
      var requestFrame =
        ...
        resetTriggers = function(contract) {
          var expandChild = contract.__resizeTriggers__,
            expand = expandChild.firstElementChild,
            contract = expandChild.lastElementChild,
      ...
      if (
        !1 === (animation = void 0 !== elm.style.animationName ? !0 : animation)
      )
      ...
      addResizeListener: function(element, fn) {
        ...
        attachEvent
          ...
          : (element.__resizeTriggers__ ||
              ((contractTrigger = element.ownerDocument),
              (expandTrigger = _window.getComputedStyle(element)) &&
                'static' == expandTrigger.position &&
              ...
              ((element.__resizeTriggers__ = contractTrigger.createElement(
                'div',
              )).className = 'resize-triggers'),
              ((expandTrigger = contractTrigger.createElement(
                'div',
              )).className = 'expand-trigger'),
              expandTrigger.appendChild(contractTrigger.createElement('div')),
              ((contractTrigger = contractTrigger.createElement(
                'div',
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(_this), '_onResize', function() {
          var height,
            ...
            paddingRight,
            paddingBottom,
            paddingTop = _this.props,
            disableHeight = paddingTop.disableHeight,
            disableWidth = paddingTop.disableWidth,
            onResize = paddingTop.onResize;
          _this._parentNode &&
            ...
            (paddingBottom =
              ...
              {}),
            (paddingLeft = parseInt(paddingBottom.paddingLeft, 10) || 0),
            (paddingRight = parseInt(paddingBottom.paddingRight, 10) || 0),
            (paddingTop = parseInt(paddingBottom.paddingTop, 10) || 0),
            (paddingBottom = parseInt(paddingBottom.paddingBottom, 10) || 0),
            ((!disableHeight &&
              _this.state.height !== height - paddingTop - paddingBottom) ||
              (!disableWidth &&
                _this.state.width !== width - paddingLeft - paddingRight)) &&
              (_this.setState({
    ...
    return (
      _createClass(AutoSizer, [
        ...
        },
        {
          key: 'render',
          value: function() {
            var outerStyle = this.props,
              children = outerStyle.children,
              className = outerStyle.className,
              disableHeight = outerStyle.disableHeight,
              disableWidth = outerStyle.disableWidth,
              style = outerStyle.style,
              childParams = this.state,
    ...
    function CellMeasurer() {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(_this), '_measure', function() {
          var width = _this.props,
            cache = width.cache,
            rowIndex = width.columnIndex,
            columnIndex = void 0 === rowIndex ? 0 : rowIndex,
            parent = width.parent,
            height = width.rowIndex,
            rowIndex = void 0 === height ? _this.props.index || 0 : height,
            width = _this._getCellMeasurements(),
            height = width.height,
            width = width.width;
        ...
        },
        {
          ...
          value: function() {
            ...
            if (
              ...
              width.hasFixedWidth() || (node.style.width = 'auto'),
                width.hasFixedHeight() || (node.style.height = 'auto');
        ...
        },
        {
          ...
          value: function() {
            var width = this.props,
              ...
              parent = width.parent,
              height = width.rowIndex,
              rowIndex = void 0 === height ? this.props.index || 0 : height;
            cache.has(rowIndex, columnIndex) ||
              ((height = (width = this._getCellMeasurements()).height),
              (width = width.width),
              cache.set(rowIndex, columnIndex, width, height),
              parent &&
  ...
  var DEFAULT_HEIGHT = 30,
    ...
    CellMeasurerCache = (function() {
      function CellMeasurerCache() {
        ...
        var defaultHeight = minWidth.defaultHeight,
          defaultWidth = minWidth.defaultWidth,
          fixedHeight = minWidth.fixedHeight,
          fixedWidth = minWidth.fixedWidth,
          keyMapper = minWidth.keyMapper,
  ...
  var reactIs_development = createCommonjsModule(function(module, exports) {
      ...
      (Suspense = 'function' == typeof Symbol && Symbol.for),
        (REACT_ELEMENT_TYPE = Suspense ? Symbol.for('react.element') : 60103),
        (REACT_PORTAL_TYPE = Suspense ? Symbol.for('react.portal') : 60106),
        (REACT_FRAGMENT_TYPE = Suspense ? Symbol.for('react.fragment') : 60107),
        (REACT_STRICT_MODE_TYPE = Suspense
          ? Symbol.for('react.strict_mode')
          : 60108),
        (REACT_PROFILER_TYPE = Suspense ? Symbol.for('react.profiler') : 60114),
        (REACT_PROVIDER_TYPE = Suspense ? Symbol.for('react.provider') : 60109),
        (REACT_CONTEXT_TYPE = Suspense ? Symbol.for('react.context') : 60110),
        (REACT_ASYNC_MODE_TYPE = Suspense
          ? Symbol.for('react.async_mode')
          : 60111),
        (REACT_CONCURRENT_MODE_TYPE = Suspense
          ? Symbol.for('react.concurrent_mode')
          : 60111),
        (REACT_FORWARD_REF_TYPE = Suspense
          ? Symbol.for('react.forward_ref')
          : 60112),
        (REACT_SUSPENSE_TYPE = Suspense ? Symbol.for('react.suspense') : 60113),
        (REACT_SUSPENSE_LIST_TYPE = Suspense
          ? Symbol.for('react.suspense_list')
          : 60120),
        (REACT_MEMO_TYPE = Suspense ? Symbol.for('react.memo') : 60115),
        (REACT_LAZY_TYPE = Suspense ? Symbol.for('react.lazy') : 60116),
        (REACT_BLOCK_TYPE = Suspense ? Symbol.for('react.block') : 60121),
        (REACT_FUNDAMENTAL_TYPE = Suspense
          ? Symbol.for('react.fundamental')
          : 60117),
        (REACT_RESPONDER_TYPE = Suspense
          ? Symbol.for('react.responder')
          : 60118),
        (REACT_SCOPE_TYPE = Suspense ? Symbol.for('react.scope') : 60119),
      ...
      : function(target, source) {
          for (
            ...
            if (getOwnPropertySymbols)
              for (
                var symbols = getOwnPropertySymbols(from), i = 0;
                i < symbols.length;
                i++
              )
  ...
  function checkPropTypes(
    ...
    for (var stack in typeSpecs)
      if (has(typeSpecs, stack)) {
        var error;
          ...
          if ('function' != typeof typeSpecs[stack]) {
            var err = Error(
              (componentName || 'React class') +
                ...
                typeof typeSpecs[stack] +
                '`.',
            );
            throw ((err.name = 'Invariant Violation'), err);
          }
          error = typeSpecs[stack](
            values,
            stack,
            componentName,
            location,
  ...
  function factoryWithTypeCheckers(isValidElement, throwOnDirectAccess) {
      ...
      ReactPropTypes = {
          ...
          return createChainableTypeChecker(function(
            ...
            return new PropTypeError(
              'Invalid ' +
                ...
                propFullName +
                '` of type `' +
                ((propValue = props[propValue]).constructor &&
        ...
        objectOf: function(typeChecker) {
          return createChainableTypeChecker(function(
            ...
            var key,
              propValue = props[propType];
            if ('object' !== (propType = getPropType(propValue)))
              return new PropTypeError(
                'Invalid ' +
                  location +
                  ' `' +
        ...
        oneOf: function(expectedValues) {
          if (Array.isArray(expectedValues))
            return createChainableTypeChecker(function(
              ...
              for (
                var propValue = props[valuesString], i = 0;
                ...
                if (
                  ...
                  return null;
              valuesString = JSON.stringify(expectedValues, function(
                key,
                value,
              ) {
    ...
    function createPrimitiveTypeChecker(expectedType) {
      return createChainableTypeChecker(function(
        ...
        return getPropType((propValue = props[propValue])) === expectedType
          ? null
          : new PropTypeError(
              'Invalid ' +
                location +
          ...
          var iteratorFn = // Before Symbol spec.
            ...
            (function(iteratorFn) {
              if (
                ...
                typeof (iteratorFn =
                  iteratorFn &&
                  ((ITERATOR_SYMBOL && iteratorFn[ITERATOR_SYMBOL]) ||
                    iteratorFn[FAUX_ITERATOR_SYMBOL]))
              )
                return iteratorFn;
            })(
              /**
  ...
  function clsx() {
    for (var tmp, x, i = 0, str = ''; i < arguments.length; )
      (tmp = arguments[i++]) &&
  ...
  function createCallbackMemoizer(argument_0) {
    ...
    return function(allInitialized) {
      var callback = allInitialized.callback,
        indices = allInitialized.indices,
        indexChanged = Object.keys(indices),
        allInitialized =
          !requireAllKeys ||
          indexChanged.every(function(value) {
            value = indices[value];
            return Array.isArray(value) ? 0 < value.length : 0 <= value;
          }),
        indexChanged =
          indexChanged.length !== Object.keys(cachedIndices).length ||
          indexChanged.some(function(value) {
            var cachedValue = cachedIndices[value],
              value = indices[value];
      ...
      function CollectionView() {
        ...
        return (
          ...
          _defineProperty(
            ...
            function() {
              var onSectionRendered = _this.props,
                cellLayoutManager = onSectionRendered.cellLayoutManager,
                onSectionRendered = onSectionRendered.onSectionRendered;
          ...
          _defineProperty(
            ...
            function() {
              var scrollLeft = _this.props,
                cellLayoutManager = scrollLeft.cellLayoutManager,
                height = scrollLeft.height,
                scrollToAlignment = scrollLeft.scrollToAlignment,
                scrollToCell = scrollLeft.scrollToCell,
                scrollPosition = scrollLeft.width,
                scrollTop = _this.state,
                scrollLeft = scrollTop.scrollLeft,
          ...
          _defineProperty(_assertThisInitialized(_this), '_onScroll', function(
            ...
            var height,
              ...
              scrollLeft,
              scrollTop;
            scrollPositionChangeReason.target === _this._scrollingContainer &&
              (_this._enablePointerEventsAfterDelay(),
              (totalHeight = (totalWidth = _this.props).cellLayoutManager),
              (height = totalWidth.height),
              (isScrollingChange = totalWidth.isScrollingChange),
              (scrollLeft = totalWidth.width),
              (scrollTop = _this._scrollbarSize),
              (totalHeight = (totalWidth = totalHeight.getTotalSize()).height),
              (totalWidth = totalWidth.width),
              (scrollLeft = Math.max(
                0,
                Math.min(
                  totalWidth - scrollLeft + scrollTop,
                  scrollPositionChangeReason.target.scrollLeft,
                ),
              )),
              (scrollTop = Math.max(
                0,
                Math.min(
                  ...
                  scrollPositionChangeReason.target.scrollTop,
                ),
              )),
              (_this.state.scrollLeft === scrollLeft &&
                _this.state.scrollTop === scrollTop) ||
                ((scrollPositionChangeReason = scrollPositionChangeReason.cancelable
        ...
        _createClass(
          ...
          [
            ...
            },
            {
              key: 'componentDidMount',
              value: function() {
                var scrollTop = this.props,
                  totalHeight = scrollTop.cellLayoutManager,
                  scrollLeft = scrollTop.scrollLeft,
                  totalWidth = scrollTop.scrollToCell,
                  scrollTop = scrollTop.scrollTop;
                ...
                (totalWidth = totalHeight.getTotalSize()),
                  (totalHeight = totalWidth.height),
                  (totalWidth = totalWidth.width);
            ...
            },
            {
              ...
              value: function(prevProps, prevState) {
                var scrollPositionChangeReason = this.props,
                  height = scrollPositionChangeReason.height,
                  scrollToAlignment =
                    scrollPositionChangeReason.scrollToAlignment,
                  scrollToCell = scrollPositionChangeReason.scrollToCell,
                  width = scrollPositionChangeReason.width,
                  scrollTop = this.state,
                  scrollLeft = scrollTop.scrollLeft,
                  scrollPositionChangeReason =
                    scrollTop.scrollPositionChangeReason,
                  scrollTop = scrollTop.scrollTop;
                scrollPositionChangeReason ===
                  SCROLL_POSITION_CHANGE_REASONS.REQUESTED &&
                  (0 <= scrollLeft &&
            ...
            },
            {
              key: 'render',
              value: function() {
                var totalWidth = this.props,
                  horizontalScrollBarSize = totalWidth.autoHeight,
                  cellCount = totalWidth.cellCount,
                  cellLayoutManager = totalWidth.cellLayoutManager,
                  className = totalWidth.className,
                  height = totalWidth.height,
                  childrenToDisplay = totalWidth.horizontalOverscanSize,
                  id = totalWidth.id,
                  noContentRenderer = totalWidth.noContentRenderer,
                  style = totalWidth.style,
                  bottom = totalWidth.verticalOverscanSize,
                  width = totalWidth.width,
                  collectionStyle = this.state,
                  isScrolling = collectionStyle.isScrolling,
                  scrollLeft = collectionStyle.scrollLeft,
                  scrollTop = collectionStyle.scrollTop;
                ...
                var verticalScrollBarSize = cellLayoutManager.getTotalSize(),
                  totalHeight = verticalScrollBarSize.height,
                  totalWidth = verticalScrollBarSize.width,
                  collectionStyle = Math.max(0, scrollLeft - childrenToDisplay),
                  verticalScrollBarSize = Math.max(0, scrollTop - bottom),
                  childrenToDisplay = Math.min(
                    totalWidth,
                    scrollLeft + width + childrenToDisplay,
                  ),
                  bottom = Math.min(totalHeight, scrollTop + height + bottom),
                  childrenToDisplay =
                    0 < height && 0 < width
                  ...
                  React.createElement(
                    'div',
                    {
                      ...
                      style: _objectSpread2(
                        _objectSpread2({}, collectionStyle),
                        style,
                      ),
                      tabIndex: 0,
                    },
              ...
              value: function(_ref) {
                ...
                this._onScrollMemoizer({
                  callback: function(height) {
                    var scrollLeft = height.scrollLeft,
            ...
            },
            {
              ...
              value: function(newState) {
                var scrollLeft = newState.scrollLeft,
                  scrollTop = newState.scrollTop,
                  newState = {
                    scrollPositionChangeReason:
                      SCROLL_POSITION_CHANGE_REASONS.REQUESTED,
                  };
              ...
              value: function(nextProps, prevState) {
                return 0 !== nextProps.cellCount ||
                  ...
                  ? nextProps.scrollLeft !== prevState.scrollLeft ||
                    ...
                    ? {
                        scrollLeft: (null != nextProps.scrollLeft
                          ? nextProps
                          : prevState
                        ).scrollLeft,
                        scrollTop: (null != nextProps.scrollTop
                          ? nextProps
                          : prevState
                        ).scrollTop,
                        scrollPositionChangeReason:
  ...
  _defineProperty(CollectionView, 'propTypes', {
    ...
    scrollToAlignment: WindowScroller.oneOf(['auto', 'end', 'start', 'center'])
      .isRequired,
        ...
        _createClass(SectionManager, [
          ...
          },
          {
            ...
            value: function(sectionXStart) {
              for (
                var height = sectionXStart.height,
                  width = sectionXStart.width,
                  x = sectionXStart.x,
                  y = sectionXStart.y,
  ...
  var Collection = (function() {
    ...
    function Collection(props, _this) {
      return (
        ...
        ((_this = _super.call(this, props, _this))._cellMetadata = []),
    ...
    return (
      _createClass(Collection, [
        ...
        },
        {
          ...
          value: function() {
            var data = this.props,
              data = (function(sectionSize) {
                for (
                  var cellCount = sectionSize.cellCount,
                    cellSizeAndPositionGetter =
                      sectionSize.cellSizeAndPositionGetter,
        ...
        },
        {
          ...
          value: function(cellMetadata) {
            var align = cellMetadata.align,
              cellIndex = cellMetadata.cellIndex,
              height = cellMetadata.height,
              scrollLeft = cellMetadata.scrollLeft,
              scrollTop = cellMetadata.scrollTop,
              width = cellMetadata.width,
              cellMetadata = this.props.cellCount;
            return (
              0 <= cellIndex &&
                cellIndex < cellMetadata &&
        ...
        },
        {
          ...
          value: function(cellGroupRenderer) {
            var _this2 = this,
              height = cellGroupRenderer.height,
              isScrolling = cellGroupRenderer.isScrolling,
              width = cellGroupRenderer.width,
              x = cellGroupRenderer.x,
              y = cellGroupRenderer.y,
              cellRenderer = this.props,
              cellGroupRenderer = cellRenderer.cellGroupRenderer,
      ...
      _createClass(ColumnSizer, [
        {
          ...
          value: function(prevProps) {
            var width = this.props,
              columnMaxWidth = width.columnMaxWidth,
              columnMinWidth = width.columnMinWidth,
              columnCount = width.columnCount,
              width = width.width;
        ...
        },
        {
          ...
          value: function() {
            var width = this.props,
              children = width.children,
              safeColumnMaxWidth = width.columnMaxWidth,
              safeColumnMinWidth = width.columnMinWidth,
              columnCount = width.columnCount,
              width = width.width,
              safeColumnMinWidth = safeColumnMinWidth || 1,
              safeColumnMaxWidth = safeColumnMaxWidth
                ? Math.min(safeColumnMaxWidth, width)
                : width,
  ...
  function calculateSizeAndPositionDataAndUpdateScrollOffset(
    ...
    var cellCount = updateScrollOffsetForScrollToIndex.cellCount,
      cellSize = updateScrollOffsetForScrollToIndex.cellSize,
      computeMetadataCallback =
        updateScrollOffsetForScrollToIndex.computeMetadataCallback,
      computeMetadataCallbackProps =
        updateScrollOffsetForScrollToIndex.computeMetadataCallbackProps,
      nextCellsCount = updateScrollOffsetForScrollToIndex.nextCellsCount,
      nextCellSize = updateScrollOffsetForScrollToIndex.nextCellSize,
      nextScrollToIndex = updateScrollOffsetForScrollToIndex.nextScrollToIndex,
      scrollToIndex = updateScrollOffsetForScrollToIndex.scrollToIndex,
      updateScrollOffsetForScrollToIndex =
        updateScrollOffsetForScrollToIndex.updateScrollOffsetForScrollToIndex;
  ...
  var CellSizeAndPositionManager = (function() {
      function CellSizeAndPositionManager(estimatedCellSize) {
        var cellCount = estimatedCellSize.cellCount,
          cellSizeGetter = estimatedCellSize.cellSizeGetter,
          estimatedCellSize = estimatedCellSize.estimatedCellSize;
        ...
        _createClass(CellSizeAndPositionManager, [
          ...
          },
          {
            ...
            value: function(cellSizeGetter) {
              var cellCount = cellSizeGetter.cellCount,
                estimatedCellSize = cellSizeGetter.estimatedCellSize,
                cellSizeGetter = cellSizeGetter.cellSizeGetter;
              (this._cellCount = cellCount),
                (this._estimatedCellSize = estimatedCellSize),
                (this._cellSizeGetter = cellSizeGetter);
            },
          ...
          },
          {
            ...
            value: function(targetIndex) {
              var totalSize = targetIndex.align,
                totalSize = void 0 === totalSize ? 'auto' : totalSize,
                containerSize = targetIndex.containerSize,
                currentOffset = targetIndex.currentOffset,
          ...
          },
          {
            ...
            value: function(start) {
              var datum = start.containerSize,
                offset = start.offset;
              if (0 === this.getTotalSize()) return {};
              for (
                var maxOffset = offset + datum,
    ...
    ScalingCellSizeAndPositionManager = (function() {
      function ScalingCellSizeAndPositionManager(params) {
        var maxScrollSize = params.maxScrollSize,
          maxScrollSize =
            void 0 === maxScrollSize ? getMaxElementSize() : maxScrollSize,
          params = _objectWithoutProperties(params, ['maxScrollSize']);
        ...
        _createClass(ScalingCellSizeAndPositionManager, [
          ...
          },
          {
            ...
            value: function(safeTotalSize) {
              var containerSize = safeTotalSize.containerSize,
                offsetPercentage = safeTotalSize.offset,
          ...
          },
          {
            key: 'getUpdatedOffsetForIndex',
            value: function(offset) {
              var currentOffset = offset.align,
                align = void 0 === currentOffset ? 'auto' : currentOffset,
                containerSize = offset.containerSize,
                currentOffset = offset.currentOffset,
                offset = offset.targetIndex,
          ...
          },
          {
            key: 'getVisibleCellRange',
            value: function(offset) {
              var containerSize = offset.containerSize,
          ...
          },
          {
            ...
            value: function(totalSize) {
              var containerSize = totalSize.containerSize,
          ...
          },
          {
            ...
            value: function(safeTotalSize) {
              var containerSize = safeTotalSize.containerSize,
                offset = safeTotalSize.offset,
                offsetPercentage = this._cellSizeAndPositionManager.getTotalSize(),
                safeTotalSize = this.getTotalSize();
          ...
          },
          {
            ...
            value: function(offsetPercentage) {
              var containerSize = offsetPercentage.containerSize,
                offset = offsetPercentage.offset,
                totalSize = this._cellSizeAndPositionManager.getTotalSize(),
                offsetPercentage = this.getTotalSize();
  ...
  function defaultOverscanIndicesGetter(stopIndex) {
    var cellCount = stopIndex.cellCount,
      overscanCellsCount = stopIndex.overscanCellsCount,
      scrollDirection = stopIndex.scrollDirection,
  ...
  function updateScrollIndexHelper(hasScrollToIndex) {
    var cellSize = hasScrollToIndex.cellSize,
      cellSizeAndPositionManager = hasScrollToIndex.cellSizeAndPositionManager,
      previousCellsCount = hasScrollToIndex.previousCellsCount,
      previousCellSize = hasScrollToIndex.previousCellSize,
      previousScrollToAlignment = hasScrollToIndex.previousScrollToAlignment,
      previousScrollToIndex = hasScrollToIndex.previousScrollToIndex,
      previousSize = hasScrollToIndex.previousSize,
      scrollOffset = hasScrollToIndex.scrollOffset,
      scrollToAlignment = hasScrollToIndex.scrollToAlignment,
      scrollToIndex = hasScrollToIndex.scrollToIndex,
      size = hasScrollToIndex.size,
      sizeJustIncreasedFromZero = hasScrollToIndex.sizeJustIncreasedFromZero,
      updateScrollIndexCallback = hasScrollToIndex.updateScrollIndexCallback,
  ...
  function defaultCellRangeRenderer(areOffsetsAdjusted) {
    for (
      var cellCache = areOffsetsAdjusted.cellCache,
        cellRenderer = areOffsetsAdjusted.cellRenderer,
        columnSizeAndPositionManager =
          areOffsetsAdjusted.columnSizeAndPositionManager,
        columnStartIndex = areOffsetsAdjusted.columnStartIndex,
        columnStopIndex = areOffsetsAdjusted.columnStopIndex,
        deferredMeasurementCache = areOffsetsAdjusted.deferredMeasurementCache,
        horizontalOffsetAdjustment =
          areOffsetsAdjusted.horizontalOffsetAdjustment,
        isScrolling = areOffsetsAdjusted.isScrolling,
        isScrollingOptOut = areOffsetsAdjusted.isScrollingOptOut,
        parent = areOffsetsAdjusted.parent,
        rowSizeAndPositionManager =
          areOffsetsAdjusted.rowSizeAndPositionManager,
        rowStartIndex = areOffsetsAdjusted.rowStartIndex,
        rowStopIndex = areOffsetsAdjusted.rowStopIndex,
        styleCache = areOffsetsAdjusted.styleCache,
        verticalOffsetAdjustment = areOffsetsAdjusted.verticalOffsetAdjustment,
        visibleColumnIndices = areOffsetsAdjusted.visibleColumnIndices,
        visibleRowIndices = areOffsetsAdjusted.visibleRowIndices,
        renderedCells = [],
        areOffsetsAdjusted =
      ...
      for (
        ...
        null !=
          ...
          ((function(parent, renderedCell) {
            (renderedCell =
              renderedCell &&
              (renderedCell.type && renderedCell.type.__internalCellMeasurerFlag
        ...
        _createClass(
          ...
          [
              ...
              value: function() {
                var offsetProps =
                    0 < arguments.length && void 0 !== arguments[0]
                      ? arguments[0]
                      : {},
                  columnIndex = offsetProps.alignment,
                  alignment =
                    void 0 === columnIndex
                      ? this.props.scrollToAlignment
                      : columnIndex,
                  columnIndex = offsetProps.columnIndex,
                  columnIndex =
                    void 0 === columnIndex
                      ? this.props.scrollToColumn
                      : columnIndex,
                  offsetProps = offsetProps.rowIndex,
                  offsetProps =
                    void 0 === offsetProps
                      ? this.props.scrollToRow
                      : offsetProps,
                  offsetProps = _objectSpread2(
            ...
            },
            {
              ...
              value: function(totalColumnsWidth) {
                var autoHeight,
                  ...
                  height,
                  totalRowsHeight,
                  width = totalColumnsWidth.scrollLeft,
                  scrollLeft = void 0 === width ? 0 : width,
                  scrollTop = totalColumnsWidth.scrollTop,
                  newState = void 0 === scrollTop ? 0 : scrollTop;
                newState < 0 ||
                  (this._debounceScrollEnded(),
                  (autoHeight = (totalRowsHeight = this.props).autoHeight),
                  (autoWidth = totalRowsHeight.autoWidth),
                  (height = totalRowsHeight.height),
                  (width = totalRowsHeight.width),
                  (scrollTop = (totalColumnsWidth = this.state.instanceProps)
                    .scrollbarSize),
                  (totalRowsHeight = totalColumnsWidth.rowSizeAndPositionManager.getTotalSize()),
                  (totalColumnsWidth = totalColumnsWidth.columnSizeAndPositionManager.getTotalSize()),
                  (scrollLeft = Math.min(
                    Math.max(0, totalColumnsWidth - width + scrollTop),
                    scrollLeft,
                  )),
                  (scrollTop = Math.min(
                    Math.max(0, totalRowsHeight - height + scrollTop),
                    newState,
                  )),
            ...
            },
            {
              ...
              value: function(rowIndex) {
                var columnIndex = rowIndex.columnIndex,
            ...
            },
            {
              key: 'measureAllCells',
              value: function() {
                var instanceProps = this.props,
                  columnCount = instanceProps.columnCount,
                  rowCount = instanceProps.rowCount,
              ...
              value: function() {
                var scrollToColumn =
                    0 < arguments.length && void 0 !== arguments[0]
                      ? arguments[0]
                      : {},
                  instanceProps = scrollToColumn.columnIndex,
                  columnIndex = void 0 === instanceProps ? 0 : instanceProps,
                  scrollToRow = scrollToColumn.rowIndex,
                  rowIndex = void 0 === scrollToRow ? 0 : scrollToRow,
                  instanceProps = this.props,
                  scrollToColumn = instanceProps.scrollToColumn,
                  scrollToRow = instanceProps.scrollToRow,
                  instanceProps = this.state.instanceProps;
            ...
            },
            {
              key: 'componentDidMount',
              value: function() {
                var stateUpdate = this.props,
                  getScrollbarSize = stateUpdate.getScrollbarSize,
                  height = stateUpdate.height,
                  scrollLeft = stateUpdate.scrollLeft,
                  scrollToColumn = stateUpdate.scrollToColumn,
                  scrollTop = stateUpdate.scrollTop,
                  scrollToRow = stateUpdate.scrollToRow,
                  sizeIsBiggerThanZero = stateUpdate.width,
                  instanceProps = this.state.instanceProps;
                (this._initialScrollTop = 0),
                  ...
                  instanceProps.scrollbarSizeMeasured ||
                    this.setState(function(stateUpdate) {
                      stateUpdate = _objectSpread2(
                        _objectSpread2({}, stateUpdate),
                        {},
                        {
                          needToResetStyleCache: !1,
                        },
            ...
            },
            {
              ...
              value: function(prevProps, totalRowsHeight) {
                var _this2 = this,
                  ...
                  autoHeight = scrollTop.autoHeight,
                  autoWidth = scrollTop.autoWidth,
                  columnCount = scrollTop.columnCount,
                  height = scrollTop.height,
                  sizeJustIncreasedFromZero = scrollTop.rowCount,
                  scrollToAlignment = scrollTop.scrollToAlignment,
                  scrollToColumn = scrollTop.scrollToColumn,
                  scrollToRow = scrollTop.scrollToRow,
                  width = scrollTop.width,
                  totalColumnsWidth = this.state,
                  scrollLeft = totalColumnsWidth.scrollLeft,
                  scrollPositionChangeReason =
                    totalColumnsWidth.scrollPositionChangeReason,
                  scrollTop = totalColumnsWidth.scrollTop,
                  totalColumnsWidth = totalColumnsWidth.instanceProps;
                this._handleInvalidatedGridSize();
                sizeJustIncreasedFromZero =
                  (0 < columnCount && 0 === prevProps.columnCount) ||
                  (0 < sizeJustIncreasedFromZero && 0 === prevProps.rowCount);
                scrollPositionChangeReason ===
                ...
                this._recomputeScrollLeftFlag
                  ...
                  : updateScrollIndexHelper({
                      cellSizeAndPositionManager:
                        totalColumnsWidth.columnSizeAndPositionManager,
                  ...
                  this._recomputeScrollTopFlag
                    ...
                    : updateScrollIndexHelper({
                        cellSizeAndPositionManager:
                          totalColumnsWidth.rowSizeAndPositionManager,
                  ...
                  this._invokeOnGridRenderedHelper(),
                  (scrollLeft === totalRowsHeight.scrollLeft &&
                    scrollTop === totalRowsHeight.scrollTop) ||
                    ((totalRowsHeight = totalColumnsWidth.rowSizeAndPositionManager.getTotalSize()),
                    (totalColumnsWidth = totalColumnsWidth.columnSizeAndPositionManager.getTotalSize()),
                    this._invokeOnScrollMemoizer({
                      scrollLeft: scrollLeft,
            ...
            },
            {
              key: 'render',
              value: function() {
                var isScrolling = this.props,
                  autoContainerWidth = isScrolling.autoContainerWidth,
                  totalColumnsWidth = isScrolling.autoHeight,
                  totalRowsHeight = isScrolling.autoWidth,
                  className = isScrolling.className,
                  containerProps = isScrolling.containerProps,
                  containerRole = isScrolling.containerRole,
                  containerStyle = isScrolling.containerStyle,
                  height = isScrolling.height,
                  id = isScrolling.id,
                  noContentRenderer = isScrolling.noContentRenderer,
                  role = isScrolling.role,
                  style = isScrolling.style,
                  tabIndex = isScrolling.tabIndex,
                  showNoContentRenderer = isScrolling.width,
                  gridStyle = this.state,
                  childrenToDisplay = gridStyle.instanceProps,
                  verticalScrollBarSize = gridStyle.needToResetStyleCache,
                ...
                verticalScrollBarSize && (this._styleCache = {}),
                ...
                (totalColumnsWidth = childrenToDisplay.columnSizeAndPositionManager.getTotalSize()),
                  (totalRowsHeight = childrenToDisplay.rowSizeAndPositionManager.getTotalSize()),
                  (verticalScrollBarSize =
                    height < totalRowsHeight
                      ? childrenToDisplay.scrollbarSize
                      : 0),
                  (childrenToDisplay =
                    showNoContentRenderer < totalColumnsWidth
                      ? childrenToDisplay.scrollbarSize
                      : 0);
                (childrenToDisplay === this._horizontalScrollBarSize &&
                  verticalScrollBarSize === this._verticalScrollBarSize) ||
                  ((this._horizontalScrollBarSize = childrenToDisplay),
                  (this._verticalScrollBarSize = verticalScrollBarSize),
                  (this._scrollbarPresenceChanged = !0)),
                  (gridStyle.overflowX =
                    totalColumnsWidth + verticalScrollBarSize <=
                    showNoContentRenderer
                      ? 'hidden'
                      : 'auto'),
                  (gridStyle.overflowY =
                    totalRowsHeight + childrenToDisplay <= height
                      ? 'hidden'
                      : 'auto');
                (childrenToDisplay = this._childrenToDisplay),
                  (showNoContentRenderer =
                    0 === childrenToDisplay.length &&
                    0 < height &&
                    0 < showNoContentRenderer);
                return React.createElement(
                  'div',
                  _extends(
                    {
            ...
            },
            {
              ...
              value: function() {
                var visibleColumnIndices =
                  ...
                  visibleRowIndices =
                    1 < arguments.length && void 0 !== arguments[1]
                      ? arguments[1]
                      : this.state,
                  cellRenderer = visibleColumnIndices.cellRenderer,
                  cellRangeRenderer = visibleColumnIndices.cellRangeRenderer,
                  columnCount = visibleColumnIndices.columnCount,
                  deferredMeasurementCache =
                    visibleColumnIndices.deferredMeasurementCache,
                  verticalOffsetAdjustment = visibleColumnIndices.height,
                  overscanColumnCount =
                    visibleColumnIndices.overscanColumnCount,
                  overscanIndicesGetter =
                    visibleColumnIndices.overscanIndicesGetter,
                  overscanRowCount = visibleColumnIndices.overscanRowCount,
                  rowCount = visibleColumnIndices.rowCount,
                  horizontalOffsetAdjustment = visibleColumnIndices.width,
                  isScrollingOptOut = visibleColumnIndices.isScrollingOptOut,
                  overscanColumnIndices =
                    visibleRowIndices.scrollDirectionHorizontal,
                  overscanRowIndices =
                    visibleRowIndices.scrollDirectionVertical,
                  instanceProps = visibleRowIndices.instanceProps,
                  scrollTop =
                    0 < this._initialScrollTop
                      ? this._initialScrollTop
                      : visibleRowIndices.scrollTop,
                  scrollLeft =
                    0 < this._initialScrollLeft
                      ? this._initialScrollLeft
                      : visibleRowIndices.scrollLeft,
                  isScrolling = this._isScrolling(
                ...
                if (
                  ...
                  0 < verticalOffsetAdjustment &&
                    0 < horizontalOffsetAdjustment)
                ) {
            ...
            },
            {
              ...
              value: function(stateUpdate) {
                var scrollLeft = stateUpdate.scrollLeft,
                  stateUpdate = stateUpdate.scrollTop,
                  stateUpdate = Grid._getScrollToPositionStateUpdate({
                    prevState: this.state,
                    scrollLeft: scrollLeft,
          ...
          [
            {
              ...
              value: function(nextProps, prevState) {
                ...
                return (
                  ...
                  _objectSpread2(
                    _objectSpread2(_objectSpread2({}, newState), maybeStateA),
                    maybeStateB,
                  )
                );
              },
            ...
            },
            {
              ...
              value: function(newState) {
                var prevState = newState.prevState,
            ...
            },
            {
              ...
              value: function(scrollLeft, instanceProps) {
                var targetIndex = scrollLeft.columnCount,
                  height = scrollLeft.height,
                  scrollToAlignment = scrollLeft.scrollToAlignment,
                  scrollBarSize = scrollLeft.scrollToColumn,
                  width = scrollLeft.width,
                  scrollLeft = instanceProps.scrollLeft,
                ...
                if (0 < targetIndex) {
                  (targetIndex = targetIndex - 1),
                    (targetIndex =
                      scrollBarSize < 0
                        ? targetIndex
                        : Math.min(targetIndex, scrollBarSize)),
                    (scrollBarSize = instanceProps.rowSizeAndPositionManager.getTotalSize()),
                    (scrollBarSize =
                      instanceProps.scrollbarSizeMeasured &&
            ...
            },
            {
              ...
              value: function(scrollTop, instanceProps) {
                var height = scrollTop.height,
                  targetIndex = scrollTop.rowCount,
                  scrollToAlignment = scrollTop.scrollToAlignment,
                  scrollBarSize = scrollTop.scrollToRow,
                  width = scrollTop.width,
                  scrollTop = instanceProps.scrollTop,
                  instanceProps = instanceProps.instanceProps;
                if (0 < targetIndex) {
                  (targetIndex = targetIndex - 1),
                    (targetIndex =
                      scrollBarSize < 0
                        ? targetIndex
                        : Math.min(targetIndex, scrollBarSize)),
                    (scrollBarSize = instanceProps.columnSizeAndPositionManager.getTotalSize()),
                    (scrollBarSize =
                      instanceProps.scrollbarSizeMeasured &&
                      width < scrollBarSize
                        ? instanceProps.scrollbarSize
      ...
      _createClass(InfiniteLoader, [
              ...
              promise &&
                promise.then(function() {
                  ...
                  (stopIndex = {
                    ...
                    (lastRenderedStartIndex = stopIndex.lastRenderedStartIndex),
                    (lastRenderedStopIndex = stopIndex.lastRenderedStopIndex),
                    (startIndex = stopIndex.startIndex),
                    (stopIndex = stopIndex.stopIndex),
        ...
        },
        {
          ...
          value: function(stopIndex) {
            var startIndex = stopIndex.startIndex,
              stopIndex = stopIndex.stopIndex;
        ...
        },
        {
          ...
          value: function(startIndex, stopIndex) {
            var _this3 = this,
              squashedUnloadedRanges = this.props,
              isRowLoaded = squashedUnloadedRanges.isRowLoaded,
              minimumBatchSize = squashedUnloadedRanges.minimumBatchSize,
              rowCount = squashedUnloadedRanges.rowCount,
              squashedUnloadedRanges = squashedUnloadedRanges.threshold,
              unloadedRanges = (function(_ref5) {
                ...
                stopIndex: Math.min(
                  rowCount - 1,
                  stopIndex + squashedUnloadedRanges,
                ),
              }),
              squashedUnloadedRanges = (squashedUnloadedRanges = []).concat.apply(
    ...
    function List() {
      ...
      return (
        ...
        _defineProperty(
          _assertThisInitialized(_this),
          '_cellRenderer',
          function(widthDescriptor) {
            var parent = widthDescriptor.parent,
              rowIndex = widthDescriptor.rowIndex,
              style = widthDescriptor.style,
              isScrolling = widthDescriptor.isScrolling,
              isVisible = widthDescriptor.isVisible,
              key = widthDescriptor.key,
        ...
        _defineProperty(_assertThisInitialized(_this), '_onScroll', function(
          ...
          var clientHeight = scrollTop.clientHeight,
            scrollHeight = scrollTop.scrollHeight,
            scrollTop = scrollTop.scrollTop;
        ...
        _defineProperty(
          ...
          '_onSectionRendered',
          function(rowStopIndex) {
            var rowOverscanStartIndex = rowStopIndex.rowOverscanStartIndex,
              rowOverscanStopIndex = rowStopIndex.rowOverscanStopIndex,
              rowStartIndex = rowStopIndex.rowStartIndex,
              rowStopIndex = rowStopIndex.rowStopIndex;
    ...
    return (
      _createClass(List, [
          ...
          value: function() {
            var _ref6$rowIndex =
                0 < arguments.length && void 0 !== arguments[0]
                  ? arguments[0]
                  : {},
              _ref6$columnIndex = _ref6$rowIndex.columnIndex,
              _ref6$rowIndex = _ref6$rowIndex.rowIndex;
            this.Grid &&
        ...
        },
        {
          ...
          value: function() {
            var width = this.props,
              classNames = width.className,
              noRowsRenderer = width.noRowsRenderer,
              scrollToIndex = width.scrollToIndex,
              width = width.width,
              classNames = clsx('ReactVirtualized__List', classNames);
            return React.createElement(
              Grid,
              _extends({}, this.props, {
  ...
  (ScrollSync.intervals = function(result) {
    ...
    (ScrollSync.insert = function(interval) {
      var l,
        r = this.count - this.leftPoints.length;
      (this.count += 1),
        interval[1] < this.mid
          ? this.left
            ? 4 * (this.left.count + 1) > 3 * (1 + r)
              ? rebuildWithInterval(this, interval)
              : this.left.insert(interval)
            : (this.left = createIntervalTree([interval]))
          : interval[0] > this.mid
          ? this.right
            ? 4 * (this.right.count + 1) > 3 * (1 + r)
              ? rebuildWithInterval(this, interval)
        ...
        _createClass(PositionCache, [
          ...
          },
          {
            ...
            value: function(scrollTop, clientHeight, renderCallback) {
              ...
              this._intervalTree.queryInterval(
                ...
                function(top) {
                  var index = _slicedToArray(top, 3),
                    top = index[0],
          ...
          },
          {
            ...
            value: function(columnHeight, left, top, height) {
              this._intervalTree.insert([top, top + height, columnHeight]),
                (this._leftMap[columnHeight] = left);
      ...
      function Masonry() {
        ...
        return (
          ...
          _defineProperty(_assertThisInitialized(_this), '_onScroll', function(
            ...
            var scrollTop = _this.props.height,
              eventScrollTop = eventScrollTop.currentTarget.scrollTop,
              scrollTop = Math.min(
                Math.max(0, _this._getEstimatedTotalHeight() - scrollTop),
                eventScrollTop,
              );
          ...
          [
            ...
            },
            {
              ...
              value: function() {
                var stopIndex,
                  _this2 = this,
                  estimateTotalHeight = this.props,
                  autoHeight = estimateTotalHeight.autoHeight,
                  cellCount = estimateTotalHeight.cellCount,
                  cellMeasurerCache = estimateTotalHeight.cellMeasurerCache,
                  cellRenderer = estimateTotalHeight.cellRenderer,
                  className = estimateTotalHeight.className,
                  height = estimateTotalHeight.height,
                  id = estimateTotalHeight.id,
                  keyMapper = estimateTotalHeight.keyMapper,
                  overscanByPixels = estimateTotalHeight.overscanByPixels,
                  role = estimateTotalHeight.role,
                  style = estimateTotalHeight.style,
                  tabIndex = estimateTotalHeight.tabIndex,
                  width = estimateTotalHeight.width,
                  rowDirection = estimateTotalHeight.rowDirection,
                  shortestColumnSize = this.state,
                  isScrolling = shortestColumnSize.isScrolling,
                  scrollTop = shortestColumnSize.scrollTop,
                  children = [],
            ...
            },
            {
              ...
              value: function() {
                var estimatedColumnCount = this.props,
                  cellCount = estimatedColumnCount.cellCount,
                  cellMeasurerCache = estimatedColumnCount.cellMeasurerCache,
                  estimatedColumnCount = estimatedColumnCount.width,
                  estimatedColumnCount = Math.max(
                    1,
                    Math.floor(
                      estimatedColumnCount / cellMeasurerCache.defaultWidth,
                    ),
                  );
            ...
            },
            {
              ...
              value: function(startIndex, stopIndex) {
                for (
                  ...
                  var top = cellPositioner(_index2),
                    left = top.left,
                    top = top.top;
  ...
  var CellMeasurerCacheDecorator = (function() {
      function CellMeasurerCacheDecorator() {
        ...
        var cellMeasurerCache = rowIndexOffset.cellMeasurerCache,
          columnIndexOffset = rowIndexOffset.columnIndexOffset,
          columnIndexOffset =
            void 0 === columnIndexOffset ? 0 : columnIndexOffset,
          rowIndexOffset = rowIndexOffset.rowIndexOffset,
          rowIndexOffset = void 0 === rowIndexOffset ? 0 : rowIndexOffset;
    ...
    MultiGrid = (function() {
      ...
      function MultiGrid(_fixedRowCount, _fixedColumnCount) {
        ...
        _classCallCheck(this, MultiGrid),
          _defineProperty(
            _assertThisInitialized(
              (_this = _super.call(this, _fixedRowCount, _fixedColumnCount)),
            ),
            'state',
            {
              scrollLeft: 0,
          ...
          _defineProperty(
            ...
            function(fixedRowCount) {
              var rowIndex = fixedRowCount.rowIndex,
                rest = _objectWithoutProperties(fixedRowCount, ['rowIndex']),
          ...
          _defineProperty(
            ...
            function(fixedColumnCount) {
              var columnIndex = fixedColumnCount.columnIndex,
                rowIndex = fixedColumnCount.rowIndex,
                rest = _objectWithoutProperties(fixedColumnCount, [
                  'columnIndex',
                  'rowIndex',
                ]),
                fixedRowCount = _this.props,
                cellRenderer = fixedRowCount.cellRenderer,
                fixedColumnCount = fixedRowCount.fixedColumnCount,
                fixedRowCount = fixedRowCount.fixedRowCount;
              return cellRenderer(
                _objectSpread2(
                  _objectSpread2({}, rest),
                  {},
          ...
          _defineProperty(
            ...
            function(columnCount) {
              var columnIndex = columnCount.columnIndex,
                rest = _objectWithoutProperties(columnCount, ['columnIndex']),
                fixedColumnCount = _this.props,
                cellRenderer = fixedColumnCount.cellRenderer,
                columnCount = fixedColumnCount.columnCount,
                fixedColumnCount = fixedColumnCount.fixedColumnCount;
          ...
          _defineProperty(
            ...
            function(_this$state) {
              var index = _this$state.index,
                scrollbarSize = _this.props,
                columnCount = scrollbarSize.columnCount,
                fixedColumnCount = scrollbarSize.fixedColumnCount,
                columnWidth = scrollbarSize.columnWidth,
          ...
          _defineProperty(
            ...
            function(showHorizontalScrollbar) {
              var horizontal = showHorizontalScrollbar.horizontal,
                size = showHorizontalScrollbar.size,
                vertical = showHorizontalScrollbar.vertical,
                onScrollbarPresenceChange = _this.state,
                showHorizontalScrollbar =
                  onScrollbarPresenceChange.showHorizontalScrollbar,
                onScrollbarPresenceChange =
                  onScrollbarPresenceChange.showVerticalScrollbar;
              (horizontal === showHorizontalScrollbar &&
                vertical === onScrollbarPresenceChange) ||
                (_this.setState({
                  scrollbarSize: size,
          ...
          _defineProperty(
            ...
            function(_this$state3) {
              var index = _this$state3.index,
                scrollbarSize = _this.props,
                fixedRowCount = scrollbarSize.fixedRowCount,
                rowCount = scrollbarSize.rowCount,
                rowHeight = scrollbarSize.rowHeight,
        ...
        var deferredMeasurementCache = _fixedRowCount.deferredMeasurementCache,
          _fixedColumnCount = _fixedRowCount.fixedColumnCount,
          _fixedRowCount = _fixedRowCount.fixedRowCount;
        return (
        ...
        _createClass(
          ...
          [
            ...
            },
            {
              ...
              value: function() {
                var rowIndex =
                  ...
                  columnIndex = void 0 === columnIndex ? 0 : columnIndex,
                  rowIndex = rowIndex.rowIndex,
                  rowIndex = void 0 === rowIndex ? 0 : rowIndex;
                (this._deferredInvalidateColumnIndex =
                  'number' == typeof this._deferredInvalidateColumnIndex
                    ? Math.min(this._deferredInvalidateColumnIndex, columnIndex)
                    : columnIndex),
              ...
              value: function() {
                var adjustedRowIndex =
                    0 < arguments.length && void 0 !== arguments[0]
                      ? arguments[0]
                      : {},
                  rowIndex = adjustedRowIndex.columnIndex,
                  columnIndex = void 0 === rowIndex ? 0 : rowIndex,
                  adjustedColumnIndex = adjustedRowIndex.rowIndex,
                  rowIndex =
                    void 0 === adjustedColumnIndex ? 0 : adjustedColumnIndex,
                  adjustedRowIndex = this.props,
                  adjustedColumnIndex = adjustedRowIndex.fixedColumnCount,
                  adjustedRowIndex = adjustedRowIndex.fixedRowCount,
                  adjustedColumnIndex = Math.max(
                    0,
                    columnIndex - adjustedColumnIndex,
                  ),
                  adjustedRowIndex = Math.max(0, rowIndex - adjustedRowIndex);
            ...
            },
            {
              key: 'render',
              value: function() {
                var scrollLeft = this.props,
                  onScroll = scrollLeft.onScroll,
                  onSectionRendered = scrollLeft.onSectionRendered,
                  scrollToColumn =
                    (scrollLeft.onScrollbarPresenceChange,
                    scrollLeft.scrollLeft,
                    scrollLeft.scrollToColumn),
                  scrollToRow = (scrollLeft.scrollTop, scrollLeft.scrollToRow),
                  rest = _objectWithoutProperties(scrollLeft, [
                    'onScroll',
                    'onSectionRendered',
                    'onScrollbarPresenceChange',
                    'scrollLeft',
            ...
            },
            {
              ...
              value: function(resetAll) {
                var topSizeChange = this.props,
                  columnWidth = topSizeChange.columnWidth,
                  enableFixedColumnScroll =
                    topSizeChange.enableFixedColumnScroll,
                  enableFixedRowScroll = topSizeChange.enableFixedRowScroll,
                  height = topSizeChange.height,
                  fixedColumnCount = topSizeChange.fixedColumnCount,
                  fixedRowCount = topSizeChange.fixedRowCount,
                  rowHeight = topSizeChange.rowHeight,
                  style = topSizeChange.style,
                  styleBottomLeftGrid = topSizeChange.styleBottomLeftGrid,
                  styleBottomRightGrid = topSizeChange.styleBottomRightGrid,
                  styleTopLeftGrid = topSizeChange.styleTopLeftGrid,
                  styleTopRightGrid = topSizeChange.styleTopRightGrid,
                  width = topSizeChange.width,
                  sizeChange =
                    resetAll ||
            ...
            },
            {
              ...
              value: function(props) {
                var enableFixedColumnScroll = props.enableFixedColumnScroll,
                  ...
                  bottomLeftGrid = this.state.showVerticalScrollbar;
                if (!fixedColumnCount) return null;
                var additionalRowCount = bottomLeftGrid ? 1 : 0,
                  height = this._getBottomGridHeight(props),
                  width = this._getLeftGridWidth(props),
                  bottomLeftGrid = this.state.showVerticalScrollbar
                    ? this.state.scrollbarSize
                    : 0,
                  bottomLeftGrid = hideBottomLeftGridScrollbar
                ...
                return hideBottomLeftGridScrollbar
                  ? React.createElement(
                      'div',
                      {
                        ...
                        style: _objectSpread2(
                          _objectSpread2({}, this._bottomLeftGridStyle),
                          {},
                          {
                            height: height,
                            width: width,
            ...
            },
            {
              ...
              value: function(props) {
                var columnCount = props.columnCount,
                  ...
                  topRightGrid = this.state,
                  showHorizontalScrollbar =
                    topRightGrid.showHorizontalScrollbar,
                  scrollbarSize = topRightGrid.scrollbarSize;
                if (!fixedRowCount) return null;
                var additionalColumnCount = showHorizontalScrollbar ? 1 : 0,
                  height = this._getTopGridHeight(props),
                  width = this._getRightGridWidth(props),
                  gridHeight = height,
                  topRightGrid = this._topRightGridStyle;
                hideTopRightGridScrollbar &&
                  ((gridHeight =
                    height + (showHorizontalScrollbar ? scrollbarSize : 0)),
                  (topRightGrid = _objectSpread2(
                    _objectSpread2({}, this._topRightGridStyle),
                    {},
                    {
                      left: 0,
                    },
                  )));
                topRightGrid = React.createElement(
                  Grid,
                  _extends({}, props, {
      ...
      _createClass(ScrollSync, [
        {
          ...
          value: function() {
            var children = this.props.children,
              ...
              clientHeight = scrollWidth.clientHeight,
              clientWidth = scrollWidth.clientWidth,
              scrollHeight = scrollWidth.scrollHeight,
              scrollLeft = scrollWidth.scrollLeft,
              scrollTop = scrollWidth.scrollTop,
        ...
        },
        {
          ...
          value: function(scrollWidth) {
            var clientHeight = scrollWidth.clientHeight,
              clientWidth = scrollWidth.clientWidth,
              scrollHeight = scrollWidth.scrollHeight,
              scrollLeft = scrollWidth.scrollLeft,
              scrollTop = scrollWidth.scrollTop,
  ...
  function SortIndicator(classNames) {
    var sortDirection = classNames.sortDirection,
  ...
  function defaultHeaderRenderer(sortDirection) {
    var showSortIndicator = sortDirection.dataKey,
      children = sortDirection.label,
      sortBy = sortDirection.sortBy,
      sortDirection = sortDirection.sortDirection,
      showSortIndicator = sortBy === showSortIndicator,
      children = [
        React.createElement(
          'span',
          {
  ...
  function defaultRowRenderer(a11yProps) {
    var className = a11yProps.className,
      columns = a11yProps.columns,
      index = a11yProps.index,
      key = a11yProps.key,
      onRowClick = a11yProps.onRowClick,
      onRowDoubleClick = a11yProps.onRowDoubleClick,
      onRowMouseOut = a11yProps.onRowMouseOut,
      onRowMouseOver = a11yProps.onRowMouseOver,
      onRowRightClick = a11yProps.onRowRightClick,
      rowData = a11yProps.rowData,
      style = a11yProps.style,
      a11yProps = {
  ...
  SortIndicator.propTypes = {
    sortDirection: WindowScroller.oneOf([
      SortDirection.ASC,
      SortDirection.DESC,
    ]),
  };
  ...
  _defineProperty(Column, 'propTypes', {
    ...
    defaultSortDirection: WindowScroller.oneOf([
      SortDirection.ASC,
      SortDirection.DESC,
    ]),
    ...
    return (
      _createClass(Table, [
          ...
          value: function() {
            var _ref3$rowIndex =
                0 < arguments.length && void 0 !== arguments[0]
                  ? arguments[0]
                  : {},
              _ref3$columnIndex = _ref3$rowIndex.columnIndex,
              _ref3$rowIndex = _ref3$rowIndex.rowIndex;
            this.Grid &&
              this.Grid.recomputeGridSize({
        ...
        },
        {
          ...
          value: function() {
            var _this2 = this,
              scrollbarWidth = this.props,
              children = scrollbarWidth.children,
              className = scrollbarWidth.className,
              disableHeader = scrollbarWidth.disableHeader,
              gridClassName = scrollbarWidth.gridClassName,
              gridStyle = scrollbarWidth.gridStyle,
              headerHeight = scrollbarWidth.headerHeight,
              headerRowRenderer = scrollbarWidth.headerRowRenderer,
              availableRowsHeight = scrollbarWidth.height,
              id = scrollbarWidth.id,
              noRowsRenderer = scrollbarWidth.noRowsRenderer,
              rowClass = scrollbarWidth.rowClassName,
              rowStyleObject = scrollbarWidth.rowStyle,
              scrollToIndex = scrollbarWidth.scrollToIndex,
              ...
              availableRowsHeight = disableHeader
                ? availableRowsHeight
                : availableRowsHeight - headerHeight,
              rowClass =
                'function' == typeof rowClass
                  ? rowClass({
                      index: -1,
                    })
                  : rowClass,
              rowStyleObject =
                'function' == typeof rowStyleObject
                  ? rowStyleObject({
                      index: -1,
                    })
                  : rowStyleObject;
            return (
              ...
              React.Children.toArray(children).forEach(function(
                ...
                flexStyles = _this2._getFlexStyleForColumn(
                  flexStyles,
                  flexStyles.props.style,
                );
        ...
        },
        {
          ...
          value: function(cellRenderer) {
            var className = cellRenderer.column,
              columnIndex = cellRenderer.columnIndex,
              renderedCell = cellRenderer.isScrolling,
              style = cellRenderer.parent,
              title = cellRenderer.rowData,
              rowIndex = cellRenderer.rowIndex,
              onColumnClick = this.props.onColumnClick,
              id = className.props,
              cellDataGetter = id.cellDataGetter,
              cellRenderer = id.cellRenderer,
        ...
        },
        {
          ...
          value: function(headerRenderer) {
            var newSortDirection,
              ...
              index = headerRenderer.index,
              id = this.props,
              classNames = id.headerClassName,
              style = id.headerStyle,
              onHeaderClick = id.onHeaderClick,
              sort = id.sort,
              sortBy = id.sortBy,
              sortDirection = id.sortDirection,
              label = column.props,
              columnData = label.columnData,
              dataKey = label.dataKey,
              defaultSortDirection = label.defaultSortDirection,
              renderedHeader = label.disableSort,
              headerRenderer = label.headerRenderer,
              id = label.id,
              label = label.label,
              sortEnabled = !renderedHeader && sort,
              classNames = clsx(
            ...
            return (
              (sortEnabled || onHeaderClick) &&
                ...
                (headerAriaSort = 'none'),
                (headerTabIndex = 0),
                (headerOnClick = onClick = function(event) {
                  sortEnabled &&
                    sort({
        ...
        },
        {
          ...
          value: function(rowRenderer) {
            var _this3 = this,
              index = rowRenderer.rowIndex,
              isScrolling = rowRenderer.isScrolling,
              key = rowRenderer.key,
              parent = rowRenderer.parent,
              style = rowRenderer.style,
              flattenedStyle = this.props,
              columns = flattenedStyle.children,
              onRowClick = flattenedStyle.onRowClick,
              onRowDoubleClick = flattenedStyle.onRowDoubleClick,
              onRowRightClick = flattenedStyle.onRowRightClick,
              onRowMouseOver = flattenedStyle.onRowMouseOver,
              onRowMouseOut = flattenedStyle.onRowMouseOut,
              className = flattenedStyle.rowClassName,
              rowGetter = flattenedStyle.rowGetter,
              rowRenderer = flattenedStyle.rowRenderer,
              flattenedStyle = flattenedStyle.rowStyle,
              scrollbarWidth = this.state.scrollbarWidth,
              className =
                'function' == typeof className
                  ...
                  : className,
              flattenedStyle =
                'function' == typeof flattenedStyle
                  ? flattenedStyle({
                      index: index,
                    })
                  : flattenedStyle,
              ...
              columns = React.Children.toArray(columns).map(function(
                column,
                columnIndex,
              ) {
              ...
              className = clsx('ReactVirtualized__Table__row', className),
  ...
  _defineProperty(Table, 'propTypes', {
    ...
    rowClassName: WindowScroller.oneOfType([
      WindowScroller.string,
      WindowScroller.func,
    ]),
    rowGetter: WindowScroller.func.isRequired,
    rowHeight: WindowScroller.oneOfType([
      WindowScroller.number,
      WindowScroller.func,
    ]).isRequired,
    rowCount: WindowScroller.number.isRequired,
    rowRenderer: WindowScroller.func,
    rowStyle: WindowScroller.oneOfType([
      WindowScroller.object,
      WindowScroller.func,
    ]).isRequired,
    scrollToAlignment: WindowScroller.oneOf(['auto', 'end', 'start', 'center'])
      .isRequired,
        ...
        return (
          ...
          _defineProperty(
            ...
            function() {
              ...
              _this._isMounted &&
                ((onScroll = _this.props.onScroll),
                (scrollLeft = _this.props.scrollElement) &&
                  ((scrollTop = getScrollOffset(scrollLeft)),
                  (scrollLeft = Math.max(
                    0,
                    scrollTop.left - _this._positionFromLeft,
                  )),
                  (scrollTop = Math.max(
                    0,
                    scrollTop.top - _this._positionFromTop,
                  )),
                  _this.setState({
                    isScrolling: !0,
                    scrollLeft: scrollLeft,
        ...
        _createClass(WindowScroller, [
          {
            ...
            value: function() {
              var dimensions =
                ...
                width = offset.width,
                offset = this._child || ReactDOM.findDOMNode(this);
              offset instanceof Element &&
                dimensions &&
                ((offset = (function(_elementRect, _containerRect) {
                  if (isWindow(_containerRect) && document.documentElement) {
                    var scrollOffset = document.documentElement,
                      elementRect = getBoundingBox(_elementRect),
                      scrollOffset = getBoundingBox(scrollOffset);
                    return {
                  ...
                  return (
                    (scrollOffset = getScrollOffset(_containerRect)),
                    (_elementRect = getBoundingBox(_elementRect)),
          ...
          },
          {
            ...
            value: function(prevScrollElement, prevState) {
              var scrollElement = this.props.scrollElement,
                prevScrollElement = prevScrollElement.scrollElement;
          ...
          },
          {
            ...
            value: function() {
              var children = this.props.children,
                width = this.state,
                isScrolling = width.isScrolling,
                scrollTop = width.scrollTop,
  ...
  _defineProperty(WindowScroller, 'defaultProps', {
    ...
    (exports.createMasonryCellPositioner = function(_ref$spacer) {
      var columnHeights,
        cellMeasurerCache = _ref$spacer.cellMeasurerCache,
        columnCount = _ref$spacer.columnCount,
        columnWidth = _ref$spacer.columnWidth,
        spacer =
          void 0 === (_ref$spacer = _ref$spacer.spacer) ? 0 : _ref$spacer;
    ...
    (exports.createTableMultiSort = function(sortCallback) {
      var _ref$defaultSortDirec =
          1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
        defaultSortBy = _ref$defaultSortDirec.defaultSortBy,
        defaultSortDirection =
          void 0 ===
          (_ref$defaultSortDirec = _ref$defaultSortDirec.defaultSortDirection)
            ? {}
            : _ref$defaultSortDirec;
      if (!sortCallback)
